...
def parameters(yaml_name: str):
    ...
    yaml_file = os.path.join(prj_dir, 'scripts/multiaba/%s.yaml' % yaml_name)
    ...
    params.checkpoint = os.path.join(save_dir, "test_models/multiaba/%s/MultiAbaTrack_ep%04d.pth.tar" %
