...
def parameters(yaml_name: str):
    ...
    yaml_file = os.path.join(prj_dir, 'scripts/multitemp/%s.yaml' % yaml_name)
    ...
    params.checkpoint = os.path.join(save_dir, "test_models/multitemp/%s/MultiTempTrack_ep%04d.pth.tar" %
