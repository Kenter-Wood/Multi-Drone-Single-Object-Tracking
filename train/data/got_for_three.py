...
from .image_loader import jpeg4py_loader
from settings import env_settings


class GOTForThree(BaseVideoDataset):
    """ GOT-10k dataset.
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        super().__init__('GOTForThree', root, image_loader)
        ...
        if split is not None:
            ...
            if split == 'train':
                file_path = os.path.join(ltr_path, 'data_split', 'got10k_train_split.txt')
            elif split == 'val':
                file_path = os.path.join(ltr_path, 'data_split', 'got10k_val_split.txt')
            elif split == 'train_full':
                file_path = os.path.join(ltr_path, 'data_split', 'got10k_train_full_split.txt')
            elif split == 'vottrain':
                file_path = os.path.join(ltr_path, 'data_split', 'got10k_vot_train_split.txt')
            elif split == 'votval':
                file_path = os.path.join(ltr_path, 'data_split', 'got10k_vot_val_split.txt')
            else:
    ...
    def get_sequence_info(self, seq_id):
        ...
        visible, visible_ratio = self._read_target_visible(seq_path, seq_id)
