...
from data.wandb_logger import WandbWriter
...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        self._init_timing()
        print("You are getting to the forward passing step!")
        for i, data in enumerate(loader, 1):
            # print("data_shape:", data['template_images'].shape)
            ...
            # 当前data中，搜索区域的维度是搜索数量*batch*通道*大小，所以不包含整个视频的长度
            # print(data['search_images'].shape)
    ...
    def _print_stats(self, i, loader, batch_size):
        ...
        if i % self.settings.print_interval == 0 or i == loader.__len__():
            ...
            # print(self.stats[loader.name].items())
            print(print_str[:-5])
            log_str = print_str[:-5] + '\n'
