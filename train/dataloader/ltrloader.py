...
string_classes = str
from utils.tensor import TensorDict, TensorList
...
def ltr_collate_stack1(batch):
    ...
    if isinstance(batch[0], torch.Tensor):
        ...
        # print("list of keys:", list(batch[0].keys())),如果得到的batch包含张量字典，会拆开，递归
